function [R_convergence, penalty_convergence, A, D] = algorithm_FDA_penalty_WOA(para, H, user_r, user_theta)
%The proposed panalty-based fully-digital approximation (FDA) method using WOA
%
%  [R_convergence, penalty_convergence, A, D] = algorithm_FDA_penalty_WOA(para, H, user_r, user_theta)
%Inputs:
